            ...
            mega: [
                {
                    ...
                    links: [
                        ...
                        { name: 'Affiliate Program', path: '/pages/affiliate-program', icon: Users },
        ...
        <>
            ...
            >
                ...
                <div className="main-container py-0">
                    <div className={`flex py-2 lg:py-3 items-center justify-between gap-6 transition-[min-height] duration-300 ${(!isScrolled && !isMobileMenuOpen) ? 'min-h-[72px] lg:min-h-[100px]' : 'min-h-[60px] lg:min-h-[76px]'}`}>

                        <div className="flex items-center flex-shrink-0 pl-2 lg:pl-6">
                            <Link to="/" className="flex items-center gap-2">
                                <img
                                    ...
                                    fetchPriority="high"
                                    decoding="sync"
                                    className={`w-auto object-contain transition-all duration-300 ${(!isScrolled && !isMobileMenuOpen) ? 'h-[56px] md:h-[90px] lg:h-[110px]' : 'h-[48px] md:h-[68px] lg:h-[80px]'}`}
                                    style={{
