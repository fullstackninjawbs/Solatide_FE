...
function Footer() {
    return (
        <footer className="bg-[#0b1426] text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
            <div className="main-container max-w-[1200px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-12 mt-2 mb-16 pt-10 border-t border-slate-700/50">
                    <div className="col-span-1 md:col-span-4 pr-6">
                        <Link to="/" className="flex items-center gap-2 mb-5">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[17px] font-bold tracking-widest text-white leading-none">SOLATIDE</span>
                                <span className="text-[9px] font-bold tracking-[0.2em] text-[#0ea5e9] leading-none mt-1">BIOSCIENCES</span>
                            </div>
                        </Link>
                        <p className="text-[12px] text-slate-400/90 leading-[1.6]">
                        ...
                        <div className="mt-5 text-[12px] text-slate-400/90 leading-relaxed">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h4 className="text-[17px] text-white mb-6">Quick Links</h4>
                        <ul className="space-y-3.5 text-[12.5px] text-slate-300">
                    ...
                    <div className="col-span-1 md:col-span-3">
                        <h4 className="text-[17px] text-white mb-6">Resources</h4>
                        <ul className="space-y-3.5 text-[12.5px] text-slate-300">
                    ...
                    <div className="col-span-1 md:col-span-3">
                        <h4 className="text-[17px] text-white mb-6">Support & Policies</h4>
                        <ul className="space-y-3.5 text-[12.5px] text-slate-300">
                ...
                <div className="border-t border-slate-800/80 pt-6 pb-2 text-center text-[11px] text-slate-400">
