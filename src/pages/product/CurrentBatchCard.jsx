        ...
        <div className="border border-slate-200 rounded-2xl bg-white overflow-hidden shadow-[0_2px_4px_rgba(0,0,0,0.02)]">
          ...
          {hasQcData && (
            <div className="mx-4 mb-4 border border-slate-100 rounded-xl overflow-hidden bg-white shadow-sm">
              ...
              <div className="flex flex-row overflow-x-auto px-5 py-4 bg-white snap-x scrollbar-hide divide-x divide-slate-100">
                {hasPurity && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={purityIcon} alt="Purity" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasIdentity && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={identityIcon} alt="Identity" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasNetContent && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={netPeptideIcon} alt="Net Peptide Content" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasFentanyl && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={fentanylScreenIcon} alt="Fentanyl Screen" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasHeavyMetals && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={heavyMetalIcon} alt="Heavy Metals" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasSterility && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={microbialIcon} alt="Microbial / Sterility" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
                ...
                {hasEndotoxin && (
                  <div className="flex gap-3 shrink-0 min-w-[160px] px-5 first:pl-0 last:pr-0">
                    <img src={endotoxinIcon} alt="Endotoxin" className="w-[56px] h-[56px] shrink-0 mt-0.5 object-contain" />
                    <div>
