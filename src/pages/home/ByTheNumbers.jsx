        ...
        <section className="relative w-full bg-[#f4f7fa] py-8 lg:py-12  overflow-hidden">
            <div className="main-container">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    {/* Card 1 */}
                    <div className="bg-white rounded-[24px] p-6 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] cursor-pointer border border-slate-100 flex flex-col text-left relative overflow-hidden group transition-all duration-300" onClick={() => { handleNavigate('/collections/glp-1-metabolic-peptides') }}>
                        ...
                        <div className="mt-auto">
                            ...
                            <Link to="/collections/glp-1-metabolic-peptides" className="inline-flex items-center justify-center bg-[#EAF7FD] text-[#00ADEE] font-bold text-[12px] px-5 py-2.5 rounded-full hover:bg-[#00ADEE] hover:text-white transition-colors self-start shadow-sm">
                                Shop
                            </Link>
                        </div>
                    ...
                    {/* Card 2 */}
                    <div className="bg-white rounded-[24px] p-6 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] cursor-pointer border border-slate-100 flex flex-col text-left relative overflow-hidden group transition-all duration-300" onClick={() => { handleNavigate('/collections/tissue-cellular-research-peptides') }}>
                        <div className="flex-grow flex flex-col">
                            <div className="flex justify-between items-start mb-6">
                                <div className="w-12 h-12 rounded-full bg-[#EAF7FD] flex items-center justify-center shrink-0 border border-[#EAF7FD]/50 shadow-sm">
                        ...
                        <div className="mt-auto">
                            ...
                            <Link to="/collections/tissue-cellular-research-peptides" className="inline-flex items-center justify-center bg-[#EAF7FD] text-[#00ADEE] font-bold text-[12px] px-5 py-2.5 rounded-full hover:bg-[#00ADEE] hover:text-white transition-colors self-start shadow-sm">
                                Shop
                            </Link>
                        </div>
                        {/* Hover Blue Bottom Line */}
                    ...
                    {/* Card 3 */}
                    <div className="bg-white rounded-[24px] p-6 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] cursor-pointer border border-slate-100 flex flex-col text-left relative overflow-hidden group transition-all duration-300" onClick={() => { handleNavigate('/collections/dermal-pigmentation-research') }}>
                        <div className="flex-grow flex flex-col">
                            <div className="flex justify-between items-start mb-6">
                                <div className="w-12 h-12 rounded-full bg-[#EAF7FD] flex items-center justify-center shrink-0 border border-[#EAF7FD]/50 shadow-sm">
                        ...
                        <div className="mt-auto">
                            ...
                            <Link to="/collections/dermal-pigmentation-research" className="inline-flex items-center justify-center bg-[#EAF7FD] text-[#00ADEE] font-bold text-[12px] px-5 py-2.5 rounded-full hover:bg-[#00ADEE] hover:text-white transition-colors self-start shadow-sm">
                                Shop
                            </Link>
                        </div>
                        {/* Hover Blue Bottom Line */}
                    ...
                    {/* Card 4 */}
                    <div className="bg-white rounded-[24px] p-6 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] cursor-pointer border border-slate-100 flex flex-col text-left relative overflow-hidden group transition-all duration-300" onClick={() => { handleNavigate('/collections/research-solutions') }}>
                        <div className="flex-grow flex flex-col">
                            <div className="flex justify-between items-start mb-6">
                                <div className="w-12 h-12 rounded-full bg-[#EAF7FD] flex items-center justify-center shrink-0 border border-[#EAF7FD]/50 shadow-sm">
                        ...
                        <div className="mt-auto">
                            ...
                            <Link to="/collections/research-solutions" className="inline-flex items-center justify-center bg-[#EAF7FD] text-[#00ADEE] font-bold text-[12px] px-5 py-2.5 rounded-full hover:bg-[#00ADEE] hover:text-white transition-colors self-start shadow-sm">
                                Shop
                            </Link>
                        </div>
                        {/* Hover Blue Bottom Line */}
