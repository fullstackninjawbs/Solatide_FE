...
const FreedomLogo = () => (
    <div className="flex flex-col items-center justify-center shrink-0 h-[100px]">
        <svg width="90" height="54" viewBox="0 0 64 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-1">
        ...
        <span className="text-[26px] font-bold text-[#4B5563] tracking-[0.2em] leading-none mb-1">FREEDOM</span>
        <span className="text-[10px] font-semibold text-[#9CA3AF] tracking-[0.3em] leading-none">DIAGNOSTICS</span>
    </div>
);

const MetrixLogo = () => (
    <div className="flex flex-col items-center justify-center shrink-0 h-[100px]">
        <span className="text-[16px] font-extrabold text-[#1f2937] leading-none mb-1">Verified by</span>
        <div className="flex items-center gap-1.5">
            ...
            <span className="text-[28px] font-bold text-[#1f2937] leading-none tracking-tight">
...
const TrustpilotLogo = () => (
    <div className="flex items-center gap-2 shrink-0 h-[100px]">
        ...
        <span className="text-[34px] font-bold text-[#1f2937] tracking-tight">Trustpilot</span>
    </div>
);

const IsoLogo = () => (
    <div className="flex items-center justify-center w-[90px] h-[90px] bg-[#0070c0] shrink-0 relative overflow-hidden rounded-md">
        <svg width="76" height="76" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute opacity-60">
        ...
        <span className="text-[36px] font-black text-white relative z-10 tracking-tighter">ISO</span>
    </div>
);
...
const GmpLogo = () => (
    <div className="flex items-center justify-center shrink-0 h-[100px]">
        <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="50" y="52" className="text-[28px] font-black fill-[#4caf50]" textAnchor="middle" dominantBaseline="middle">GMP</text>
            <text x="50" y="65" className="text-[8px] font-bold fill-[#4caf50]" textAnchor="middle">CERTIFIED</text>
        </svg>
    </div>
);
...
const JanoshikLogo = () => (
    <div className="flex flex-col items-center justify-center shrink-0 h-[100px]">
        <svg width="84" height="50" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-1">
        ...
        <span className="text-[24px] font-bold tracking-widest leading-none">
...
const TrustBanner = () => {
    ...
    return (
        <section className="w-full bg-white overflow-hidden py-10 relative z-10">
            <div className="flex w-max shrink-0 animate-marquee-four-sets hover:[animation-play-state:paused] cursor-pointer gap-12 px-6 md:gap-16 md:px-10">
                {allLogos}
            </div>
        </section>
    );
