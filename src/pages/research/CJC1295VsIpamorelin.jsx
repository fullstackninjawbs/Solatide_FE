...
const Page = () => (
    <div className="min-h-screen bg-white font-sans">
        <Helmet>
            <title>CJC-1295 vs Ipamorelin | Solatide Biosciences</title>
            <meta name="description" content="Comparing CJC-1295 and Ipamorelin in growth hormone secretagogue research. Different receptor mechanisms and half-lives examined in laboratory models." />
            <link rel="canonical" href="https://solatidebiosciences.com.au/pages/cjc-1295-vs-ipamorelin" />
        </Helmet>
        <section className="w-full py-4 text-center border-b border-slate-100 mb-10">
            <div className="main-container">
                <h1 className="text-[48px] md:text-[46px] font-bold text-center text-[#214A9E] leading-tight">CJC-1295 vs Ipamorelin</h1>
            </div>
        </section>
        <div className="main-container pb-16">
            ...
            <div className="mb-10">
                ...
                <p className="text-[14px] text-slate-700 leading-[1.8]">CJC-1295 and Ipamorelin are both growth hormone secretagogues but operate through entirely different receptor mechanisms. CJC-1295 is a GHRH analogue that binds GHRH receptors on pituitary cells, while Ipamorelin is a ghrelin mimetic that activates growth hormone secretagogue receptors (GHSR). Research compares their distinct mechanisms, GH pulse profiles, and downstream signalling characteristics.</p>
            </div>
            <div className="mb-10 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border border-[#E2E8F0] rounded-[8px] p-5 bg-white">
                    ...
                    <ul className="list-disc pl-4 space-y-2 text-[13.5px] text-slate-700">
                        <li>GHRH receptor agonist (pituitary cells)</li>
                        <li>Short acting without DAC modification</li>
                        <li>Natural GH pulse pattern preserved</li>
                        <li>Studied for GHRH pathway research</li>
                    </ul>
                </div>
                <div className="border border-[#E2E8F0] rounded-[8px] p-5 bg-white">
                    <h3 className="text-[15px] font-bold text-[#214A9E] mb-3">Ipamorelin</h3>
                    <ul className="list-disc pl-4 space-y-2 text-[13.5px] text-slate-700">
                        <li>GHSR (ghrelin receptor) agonist</li>
                        <li>Selective GH release without cortisol spike</li>
                        <li>5-amino acid pentapeptide</li>
                        <li>Studied for specificity vs other GHRP peptides</li>
                    </ul>
                </div>
            </div>
            <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <Link to="/pages/what-is-ipamorelin" className="inline-flex items-center gap-2 border border-slate-200 bg-white px-4 py-2 rounded-full text-[12.5px] text-[#3390ec] hover:bg-slate-50 transition-colors">What Is Ipamorelin?</Link>
