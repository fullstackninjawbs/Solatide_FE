            ...
            <div className="main-container pb-16">
                ...
                <div className="bg-[#F0F5FB] border-l-[3px] border-[#1a4494] p-5 mb-14 rounded-[4px]">
                    <p className="text-[13.5px] text-slate-700 leading-relaxed">
                        <strong className="text-[#150F3A]">Research Use Only:</strong> All peptides and compounds discussed on this page are intended strictly for in-vitro laboratory research purposes only. Not for human consumption, medical treatment, or veterinary use. <Link to="/pages/research-use-disclaimer" className="text-[#3390ec] hover:underline">Read our full disclaimer.</Link>
                    </p>
                </div>
                ...
                <div className="mb-14">
                    ...
                    <p className="text-[14px] text-slate-700 mb-6 leading-[1.8]">
                        A plain-language guide to research peptides, covering common categories, laboratory use, handling considerations, quality documentation and research-use terminology. If you already know the compound you need, use the <Link to="/pages/research-compound-database" className="text-[#3390ec] hover:underline">Compound Index</Link> instead.
                    </p>
                    <div className="flex flex-wrap gap-4">
                        <Link to="/pages/research-compound-database" className="bg-[#1a4494] text-white px-6 py-2.5 rounded-full text-[13px] font-semibold hover:bg-[#163678] transition-colors shadow-sm">Browse the Compound Index</Link>
                        <Link to="/pages/research-library" className="border border-[#1a4494] text-[#1a4494] px-6 py-2.5 rounded-full text-[13px] font-semibold hover:bg-[#F0F5FB] transition-colors">All Research Resources</Link>
                    </div>
                </div>
                ...
                <div className="mb-14">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-[#F8FAFC] border-l-[3px] border-[#3390ec] p-6 rounded-[4px]">
                            ...
                            <p className="text-[13.5px] text-slate-700 leading-relaxed">Investigated in skin biology research, matrix remodelling studies and cosmetic science applications. GHK-Cu is the primary copper peptide complex in this category. <Link to="/pages/what-is-ghk-cu" className="text-[#3390ec] hover:underline">What Is GHK-Cu?</Link></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-14">
                    ...
                    <div className="space-y-6 text-[14px]">
                        ...
                        <div>
                            ...
                            <p className="text-slate-700 leading-[1.8]">Lyophilised peptides require reconstitution prior to use. Use the <Link to="/pages/concentration-calculator" className="text-[#3390ec] hover:underline">Concentration Calculator</Link> to determine the correct solvent volume for your target concentration.</p>
                        </div>
                        <div>
                            <h4 className="font-bold text-[#150F3A] mb-2 text-[14.5px]">Handling Precautions</h4>
                            <p className="text-slate-700 leading-[1.8]">Follow standard laboratory safety protocols including appropriate PPE, designated laboratory spaces and institutional biosafety guidelines. <Link to="/pages/contact-us" className="text-[#3390ec] hover:underline">Contact us</Link> if you have questions about a specific compound.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-14">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Link to="/pages/coa-lab-testing" className="bg-[#1a4494] text-white px-6 py-2.5 rounded-full text-[13px] font-semibold hover:bg-[#163678] transition-colors shadow-sm">COA & Lab Testing</Link>
                        <Link to="/pages/coa" className="border border-[#1a4494] text-[#1a4494] px-6 py-2.5 rounded-full text-[13px] font-semibold hover:bg-[#F0F5FB] transition-colors">View COA Library</Link>
                    </div>
                </div>
                ...
                <div className="mb-14">
                    ...
                    <div className="flex flex-wrap gap-3 mb-12">
                        ...
                        <Link to="/pages/research-use-disclaimer" className="inline-flex items-center gap-2 border border-slate-200 bg-white px-4 py-2 rounded-full text-[12.5px] text-[#3390ec] hover:bg-slate-50 transition-colors">
                    ...
                    <div className="bg-[#F0F5FB] border-l-[3px] border-[#1a4494] p-5 rounded-[4px]">
                        <p className="text-[13.5px] text-slate-700 leading-relaxed">
                            <strong className="text-[#150F3A]">Research Use Only:</strong> All peptides are manufactured for in-vitro laboratory research and are not intended for human consumption, medical use, or veterinary applications. <Link to="/pages/research-use-disclaimer" className="text-[#3390ec] hover:underline">Full disclaimer.</Link>
                        </p>
                    </div>
                </div>
            </div>
